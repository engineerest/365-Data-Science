...
few_shot_prompt = FewShotPromptTemplate(example=examples,
                                                   example_prompt=example_template) # Remember to include:
                                                                                    # input_variables = ['pet']
...
chain = LLMChain(llm=chat, prompt=chat_template) # LangChain Expression Language (LCEL)
